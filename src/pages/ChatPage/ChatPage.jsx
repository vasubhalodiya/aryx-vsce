    ...
    <>
      ...
      <div className="chat-list" ref={listRef}>
        ...
        {messages.map((item) => {
          if (item.role === 'tool') {
            return (
              <div className="message tool-call" key={item.id}>
                <span className="tool-call-text">⚙ {item.text}</span>
              </div>
            );
          }
          return (
        ...
        <div className="chat-input-child">
          ...
          <div className="chat-input-actions">
            <div className="chat-input-actions-left">
              ...
              <div className={`action-dot ${selectedModel ? 'action-dot-model' : ''}`} title={selectedModel || 'Options'}>
                ...
                {!!selectedModel && <span className="action-dot-model-text">{selectedModel}</span>}
              </div>
            </div>
